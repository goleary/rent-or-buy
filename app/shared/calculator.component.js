System.register(['angular2/core', 'primeng/primeng', './slider-number.component'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            CalculatorComponent = (function () {
                ...
                CalculatorComponent.prototype.calculateMonthlyPayment = function () {
                    this.monthlyPayment = this.principal * this.monthlyInterest / (1 - Math.pow(1 + this.monthlyInterest, -this.periodInMonths));
                };
                CalculatorComponent.prototype.calculatePrincipal = function () {
                    this.principal = this.monthlyPayment * (1 - Math.pow(1 + this.monthlyInterest, -this.periodInMonths)) / this.monthlyInterest;
                };
                CalculatorComponent.prototype.updateRent = function (rent) {
                    this.rent = rent;
                };
                CalculatorComponent.prototype.updatePrincipal = function (principal) {
                    this.principal = principal;
                    this.calculateMonthlyPayment();
                };
                CalculatorComponent.prototype.updatePeriod = function (period) {
                    this.periodInMonths = period * 12;
                    this.calculateMonthlyPayment();
                };
                CalculatorComponent.prototype.updateMonthlyPayment = function (monthlyPayment) {
                    this.monthlyPayment = monthlyPayment;
                    this.calculatePrincipal();
                };
                CalculatorComponent.prototype.updateInterest = function (interest) {
